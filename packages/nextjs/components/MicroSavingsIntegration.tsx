      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">{formatBalance(totalSavings)} U2U</div>
            <div className="text-sm text-gray-500 dark:text-gray-400">Total Savings</div>
            <div className="text-xs text-gray-400">≈ ${(Number(formatEther(totalSavings)) * 0.1).toFixed(2)} USD</div>
          </div>
          <div className="text-center">
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-lg font-semibold text-gray-900 dark:text-white">{activeVaults}</div>
