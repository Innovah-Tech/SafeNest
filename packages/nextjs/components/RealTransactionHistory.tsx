      ...
      <div className="card bg-base-100 shadow-xl p-6">
        ...
        <div className="flex gap-2 flex-wrap">
          <button
            ...
            onClick={() => addTransaction(0, 'deposit', BigInt("1000000000000000000"), "0x" + Math.random().toString(16).substr(2, 64))}
          >
            Add Micro-Savings Deposit
          </button>
          <button
            className="btn btn-sm btn-secondary"
            onClick={() => addTransaction(1, 'deposit', BigInt("2000000000000000000"), "0x" + Math.random().toString(16).substr(2, 64))}
          >
            Add Pension Deposit
          </button>
          <button
            className="btn btn-sm btn-accent"
            onClick={() => addTransaction(2, 'deposit', BigInt("500000000000000000"), "0x" + Math.random().toString(16).substr(2, 64))}
          >
            Add Emergency Deposit
          </button>
          <button
            className="btn btn-sm btn-outline"
            onClick={() => addTransaction(0, 'withdraw', BigInt("100000000000000000"), "0x" + Math.random().toString(16).substr(2, 64))}
          >
